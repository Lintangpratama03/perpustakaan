...
class AnggotaHapusController extends Controller
{
    public function index()
    {
        $users = User::where('is_deleted', 1)->where('id_posisi', '!=', 1)->get();
        return view('anggotahps.users-management', compact('users'));
    }
