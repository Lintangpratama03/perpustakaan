                            ...
                            <div class="position-absolute w-40 top-0 start-0 h-100 d-md-block d-none">
                                <div class="oblique-image position-absolute d-flex fixed-top ms-auto h-100 z-index-0 bg-cover me-n8"
                                    ...
                                    <div class="my-auto text-start max-width-350 ms-7">
                                        <h1 class="mt-3 text-white font-weight-bolder">SMPN 1 <br> LAWANG.</h1>
                                        <p class="text-white text-lg mt-4 mb-4">" Google dapat mengembalikan 100.000
                                            jawaban kepadamu, pustakawan dapat mengembalikan jawaban yang benar. " </p>
                                        <p class="text-white text-lg mt-4 mb-4"> - Neil Gaiman</p>
                                    </div>
                                    <div class="text-start position-absolute fixed-bottom ms-7">
                                        <h6 class="text-white text-sm mb-5">Copyright © 2024 Alfito Dea.</h6>
                                    </div>
                                </div>
                            </div>
                        </div>
